...
class TogetherAdFullscreen {
  final tag = DateTime.now().millisecondsSinceEpoch.toString();
  static const _channel = MethodChannel('com.xujiaji.togetherad/fullscreen');
  String alias;
  TogetherFullscreenCallback? callback;

  TogetherAdFullscreen({required this.alias, this.callback}) {
